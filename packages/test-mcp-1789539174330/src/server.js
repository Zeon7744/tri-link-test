...
const server = new Server({ name: 'test-mcp-1789539174330', version: '1.0.0' }, {
  capabilities: { tools: {} },
});
...
function ghRequest(reqPath) {
  return new Promise((resolve, reject) => {
    const options = {
      ...
      path: reqPath,
      headers: { 'User-Agent': 'test-mcp-1789539174330-agent/1.0', 'Accept': 'application/vnd.github.v3+json' }
    };
...
async function main() {
  ...
  console.error('test-mcp-1789539174330 MCP server running on stdio');
}
