...
const server = new Server({ name: 'test-mcp-dup-1789539174415', version: '1.0.0' }, {
  capabilities: { tools: {} },
});
...
function ghRequest(reqPath) {
  return new Promise((resolve, reject) => {
    const options = {
      ...
      path: reqPath,
      headers: { 'User-Agent': 'test-mcp-dup-1789539174415-agent/1.0', 'Accept': 'application/vnd.github.v3+json' }
    };
...
async function main() {
  ...
  console.error('test-mcp-dup-1789539174415 MCP server running on stdio');
}
